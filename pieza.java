/**
 * Clase Pieza Clase en la que se encuentran todos los datos y manejos
 * respectivos a las piezas
 * 
...
public class Pieza {
    ...
    /**
     * Constructor de la clase pieza, instancia una pieza y sus posibles rotaciones
     * para posterior necesidad.
     * 
     * @param id Numero del 1 al 7
     */
    public Pieza(int id) {
        idPieza = id;
        rotaciones = 0;
    ...
    // Metodos:
    /**
     * Toma la pieza actual y la rota una vez hacia la derecha.
     */
    ...
    /**
     * Muestra la pieza actual por pantalla cada vez que sea rotada.
     */
